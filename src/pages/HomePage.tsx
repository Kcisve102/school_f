  ...
  return (
    <div className="min-h-screen bg-page-gradient">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Content - Centered */}
        <div className="relative z-10 w-full px-6 lg:px-12 xl:px-20 py-16 sm:py-32 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Main Headline.
                Sized with clamp rather than breakpoint steps: the display face is
                monospace, so it sets far wider than a proportional font at the same
                size and wrapped to five lines at 375px, pushing the CTA off-screen.
                Fluid sizing keeps it to two or three lines across the range. */}
            <h1 className="text-[clamp(2rem,8.5vw,4.5rem)] font-medium tracking-tight text-text-primary mb-6 leading-[1.05]">
              {t.headline1}
